...
gpraAdultAllRedCapFull = rename(gpraAdultAllRedCapFull, c("DEPLOYEDIRAQ___1" = "DEPLOYEDIRAQ", "DEPLOYEDPERS___1" = "DEPLOYEDPERS"))
...
gpraYouth3month = rbind(gpraYouth3month, gpraAdultAllRedCapFull)

## need rbind this data with gpraAdult3month
